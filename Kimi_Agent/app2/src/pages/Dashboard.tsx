...
const marketOverview = [
  { symbol: 'SPY', name: 'S&P 500', price: 5247.83, change: 1.24, sparkline: [5100, 5120, 5150, 5130, 5180, 5200, 5220, 5247.83] },
  { symbol: 'QQQ', name: 'NASDAQ 100', price: 18473.52, change: 1.27, sparkline: [18000, 18100, 18250, 18150, 18300, 18400, 18450, 18473.52] },
  { symbol: 'DIA', name: 'Dow Jones', price: 39123.66, change: 0.88, sparkline: [38500, 38600, 38700, 38800, 38900, 39000, 39050, 39123.66] },
];
...
const recentSignals: Array<{
  ...
  { id: '1', type: 'BUY', ticker: 'AAPL', description: 'Pyramid Entry L3', targetPrice: '$178.50', time: '5 min ago', strategyColor: '#00E676' },
  { id: '2', type: 'STRONG_BUY', ticker: 'NVDA', description: 'VIX Panic Buy L4', targetPrice: '$920.00', time: '8 min ago', strategyColor: '#00D9C0' },
  { id: '3', type: 'BUY', ticker: 'SPY', description: 'ETF Accumulation', targetPrice: '$545.00', time: '12 min ago', strategyColor: '#6366F1' },
  { id: '4', type: 'SELL', ticker: 'META', description: 'Take Profit 15%', targetPrice: '$465.00', time: '18 min ago', strategyColor: '#FF1744' },
  { id: '5', type: 'HOLD', ticker: 'TSLA', description: 'Wait for Breakout', targetPrice: '$200.00', time: '25 min ago', strategyColor: '#FBBF24' },
  { id: '6', type: 'BUY', ticker: 'AMD', description: 'Support Bounce', targetPrice: '$158.00', time: '32 min ago', strategyColor: '#00E676' },
...
const watchlist = [
  { symbol: 'AAPL', name: 'Apple Inc.', price: 189.25, change: 1.45, signal: 'BUY' as SignalType, maStatus: 'Golden Cross', volume: 52400000 },
  { symbol: 'MSFT', name: 'Microsoft', price: 425.80, change: 0.82, signal: 'HOLD' as SignalType, maStatus: 'Above MA20', volume: 22100000 },
  { symbol: 'GOOGL', name: 'Alphabet', price: 165.40, change: -0.35, signal: 'HOLD' as SignalType, maStatus: 'Sideways', volume: 18900000 },
  { symbol: 'AMZN', name: 'Amazon', price: 178.20, change: 1.12, signal: 'BUY' as SignalType, maStatus: 'Above MA5', volume: 31200000 },
  { symbol: 'NVDA', name: 'NVIDIA', price: 875.30, change: 3.25, signal: 'STRONG_BUY' as SignalType, maStatus: 'Golden Cross', volume: 48700000 },
  { symbol: 'META', name: 'Meta', price: 485.20, change: -0.68, signal: 'SELL' as SignalType, maStatus: 'Below MA5', volume: 15600000 },
  { symbol: 'TSLA', name: 'Tesla', price: 175.50, change: 0.15, signal: 'HOLD' as SignalType, maStatus: 'Sideways', volume: 98400000 },
  { symbol: 'AMD', name: 'AMD', price: 142.80, change: 2.18, signal: 'BUY' as SignalType, maStatus: 'Above MA20', volume: 45600000 },
];
