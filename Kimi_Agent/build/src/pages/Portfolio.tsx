...
const mockPositions: Position[] = [
  // Aggressive Account
  { ticker: 'NVDA', name: 'NVIDIA Corp.', shares: 350, avgCost: 138.50, currentPrice: 195.55, account: 'aggressive', signal: 'HOLD', weight: 12.4 },
  { ticker: 'AAPL', name: 'Apple Inc.', shares: 520, avgCost: 218.00, currentPrice: 312.66, account: 'aggressive', signal: 'BUY', weight: 8.7 },
  { ticker: 'TSLA', name: 'Tesla Inc.', shares: 180, avgCost: 318.00, currentPrice: 419.77, account: 'aggressive', signal: 'HOLD', weight: 6.2 },
  { ticker: 'AMD', name: 'AMD Inc.', shares: 450, avgCost: 385.00, currentPrice: 552.05, account: 'aggressive', signal: 'HOLD', weight: 5.8 },
  { ticker: 'META', name: 'Meta Platforms', shares: 95, avgCost: 458.00, currentPrice: 600.29, account: 'aggressive', signal: 'HOLD', weight: 4.9 },
  { ticker: 'AMZN', name: 'Amazon.com', shares: 220, avgCost: 168.00, currentPrice: 195.00, account: 'aggressive', signal: 'BUY', weight: 4.5 },
  { ticker: 'GOOGL', name: 'Alphabet Inc.', shares: 180, avgCost: 148.50, currentPrice: 170.00, account: 'aggressive', signal: 'HOLD', weight: 4.1 },
  ...
  // Stable Account
  { ticker: 'MSFT', name: 'Microsoft Corp.', shares: 260, avgCost: 372.00, currentPrice: 425.00, account: 'stable', signal: 'BUY', weight: 6.5 },
  { ticker: 'QQQ', name: 'Invesco QQQ Trust', shares: 200, avgCost: 448.00, currentPrice: 487.00, account: 'stable', signal: 'HOLD', weight: 6.2 },
  { ticker: 'SPY', name: 'SPDR S&P 500 ETF', shares: 150, avgCost: 512.00, currentPrice: 525.00, account: 'stable', signal: 'BUY', weight: 5.8 },
  { ticker: 'VTI', name: 'Vanguard Total Stock', shares: 180, avgCost: 228.00, currentPrice: 268.45, account: 'stable', signal: 'HOLD', weight: 3.5 },
  // Defensive Account
  { ticker: 'BRK.B', name: 'Berkshire Hathaway', shares: 420, avgCost: 395.00, currentPrice: 413.00, account: 'defensive', signal: 'HOLD', weight: 8.2 },
