...
const INDICES: IndexCard[] = [
  {
    symbol: 'SPX', name: 'S&P 500', price: 525.00, change: 6.43, changePercent: 1.24,
    ytdChange: 12.8, high52: 5264.85, low52: 4122.39,
    sparkline: generateSparkline(5180, 20, 15),
  },
  {
    symbol: 'NDX', name: 'NASDAQ 100', price: 487.00, change: 6.11, changePercent: 1.27,
    ytdChange: 15.3, high52: 18712.75, low52: 14092.75,
    sparkline: generateSparkline(18240, 20, 45),
  },
  {
    symbol: 'DJI', name: 'Dow Jones', price: 391.50, change: 3.42, changePercent: 0.88,
    ytdChange: 6.2, high52: 39282.08, low52: 32327.20,
    sparkline: generateSparkline(38780, 20, 30),
  },
  {
    symbol: 'RUT', name: 'Russell 2000', price: 204.15, change: 2.86, changePercent: 1.42,
